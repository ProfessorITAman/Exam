...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Warrior warrior1 = new Warrior("Ahiles", 190, 10);
        ...
        Medic assistant = new Medic("Connor", 200, 5, 5);

        Witcher witcher = new Witcher("Miss Smarty", 300, 0);

        Hero[] heroes = {warrior1, doc, warrior2, magic, berserk, assistant, witcher};
